                ...
                <div className="mt-12">
                    <div>
                        <div>
                            ...
                            <input name="taiKhoan" onChange={formik.handleChange} className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" placeholder={t(INPUT_USERNAME)} />
                        </div>
                        <div className="mt-8">
                            ...
                            <input type="password" name="matKhau" onChange={formik.handleChange} className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" placeholder={t(INPUT_PASSWORD)} />
                        </div>
                        <div className="mt-10">
                  ...
                  shadow-lg">
                    ...
                    <div className="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                        {t(NOT_HAVE_ACCOUNT)} <NavLink to="register" className="cursor-pointer text-indigo-600 hover:text-indigo-800">{t(SIGN_UP)}</NavLink>
                    </div>
                </div>
            </div>
        </form>
